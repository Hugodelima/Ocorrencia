...
def gravar_log(backup,text,ocorrencia):
    arquivo = open('log.txt', 'a', encoding='utf-8')
    data_e_hora_atuais = datetime.now()
    data_e_hora_em_texto = data_e_hora_atuais.strftime('%d/%m/%Y %H:%M')
    arquivo.write(str(data_e_hora_em_texto) + text + str(backup) + str('ocorrencia') + '\n')
        ...
        if opcao == 1:
            ...
            if posicao != -1:
                ...
                if resp == "sim":
                    ...
                    editar_e_excluir_ocorrencia(lista_ocorrencias)
                    gravar_log(backup,' Foi Alterado com sucesso',lista_ocorrencias[posicao])
            ...
            print("Mostrar Log!!!")
            arquivo_log = open('log.txt','r' encoding='utf-8')
        elif opcao == 0:
...
def cadastro(lista_ocorrencias, count):
    ...
    gravar_log(ocorrencia,' Foi Cadastrado com sucesso','')
